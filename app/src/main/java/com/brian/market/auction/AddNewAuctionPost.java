...
public class AddNewAuctionPost extends AppCompatActivity implements OnMapReadyCallback,
    ...
    EditText editPostTitle, editPostDescription, editPostPrice,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = AddNewAuctionPost.this;
...
//        mLocationAutoTextView.setOnItemClickListener(this);
        ...
        weeks.add("Select duration week");
        weeks.add("1");
        weeks.add("2");
        weeks.add("3");
        weeks.add("4");
                    ...
                    try {
                        ...
                        if (responseObj.isSuccessful()) {
                            ...
                            if (response.getBoolean("success")) {
                                Log.d("info auction object", response.toString());
                                ...
                                editPostTitle.setText(auction.getTitle());
                                editPostDescription.setText(auction.getDescription());
                                editPostPrice.setText(auction.getStartPrice());
...
//        request.setCountry("US");
        ...
        placesClient.findAutocompletePredictions(request.build()).addOnSuccessListener((response) -> {
            ...
            ArrayAdapter<?> adapter = new ArrayAdapter<Object>(AddNewAuctionPost.this, android.R.layout.simple_dropdown_item_1line, data);
...
//        }
        ...
        if(myId != null)
            params.addProperty("auction_id", myId);
//            jsonObj = jsonObject.getJSONObject("data").getJSONObject("profile");
        ...
        params.addProperty("duration", weekSpinner.getSelectedItemPosition());
...
//            }
        ...
        if (SettingsMain.isConnectingToInternet(context)) {
            ...
            SettingsMain.showDilog(context);
            Log.d("info auction Data", "" + params.toString());
            Call<ResponseBody> myCall = restService.postAuction(params, UrlController.AddHeaders(this));
            myCall.enqueue(new Callback<ResponseBody>() {
                @Override
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> responseObj) {
                    try {
...
//        }
        ...
        GPSTracker gpsTracker = new GPSTracker(AddNewAuctionPost.this);
...
//        Toast.makeText(this, "Current location:\n" + location, Toast.LENGTH_LONG).show();
    ...
    public void onSuccess(LocationEngineResult result) {
        ...
        if (location != null) {
            Geocoder geocoder = new Geocoder(AddNewAuctionPost.this, Locale.getDefault());
            try {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(AddNewAuctionPost.this, 990);
...
//                    }
                ...
                displayLocationSettingsRequest(AddNewAuctionPost.this);
            }
        } else {
...
//    }
    ...
    public class ViewDialog {
        ...
        public void showDialog(Activity activity, String msg) {
            ...
            Glide.with(AddNewAuctionPost.this).load(R.drawable.angry).into(imageView);
...
//        }
    ...
    private void adforest_showDate(final EditText editText) {
        DatePickerDialog datePickerDialog = new DatePickerDialog(AddNewAuctionPost.this, (view, year, month, dayOfMonth) -> {
...
//        if (imageLimit > 0) {
        FilePickerBuilder.getInstance().setMaxCount(per_limit)
                ...
                .pickPhoto(AddNewAuctionPost.this);
//        goToImageIntent();
