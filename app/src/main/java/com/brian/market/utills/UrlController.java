...
import com.brian.market.utills.Network.AuthenticationInterceptor;
...
public class UrlController {
    ...
    private static OkHttpClient okHttpClient = new OkHttpClient.Builder()
     ...
     public static String IP_ADDRESS = "https://www.joiintapp.com/";//Enter You Ip_Address here here
...
//    private static String Custom_Security = "Enter the Custom Security code here";//Enter the Custom Security code here
    private static String Base_URL = IP_ADDRESS + "api/user/market/";
