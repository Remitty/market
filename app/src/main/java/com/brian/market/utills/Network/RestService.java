package com.brian.market.utills.Network;
...
//            @HeaderMap Map<String, String> headers
    ...
    @POST("home")
    Call<ResponseBody> postHomeDetails(
    ...
    @POST("order/confirm")
    Call<ResponseBody> orderconfirm(
            @Body JsonObject jsonObject,
            @HeaderMap Map<String, String> headers
    );

    @POST("order/cancel")
    Call<ResponseBody> ordercancel(
            @Body JsonObject jsonObject,
            @HeaderMap Map<String, String> headers
    );

    @POST("order/cancel/info")
    ...
    Call<ResponseBody> sellerproductlist(
            @HeaderMap Map<String, String> headers
    );
    ...
    @POST("stripe/account/save")
    Call<ResponseBody> stripeconnect(
            @Body JsonObject jsonObject,
            @HeaderMap Map<String, String> headers
    );

    @POST("mycart")
    Call<ResponseBody> mycart(
            @Body JsonObject jsonObject,
            @HeaderMap Map<String, String> headers
    );
...
///delete chat item
    ...
    @GET("auction/")
    Call<ResponseBody> getAuctionDetail(
    ...
    @GET("myauction/list")
    Call<ResponseBody> getMyAuctionList(
            @HeaderMap Map<String, String> headers
    );
    @POST("auction/bet")
    Call<ResponseBody> postBet(
            @Body JsonObject jsonObject,
            @HeaderMap Map<String, String> headers
    );
