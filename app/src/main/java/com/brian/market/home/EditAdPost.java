...
public class EditAdPost extends AppCompatActivity implements OnMapReadyCallback,
        ...
        , RuntimePermissionHelper.permissionInterface, AdapterView.OnItemClickListener, PermissionsListener, LocationEngineCallback<LocationEngineResult>, com.mapbox.mapboxsdk.maps.OnMapReadyCallback, OnLocationClickListener, OnCameraTrackingChangedListener {
    ...
    private CardView cardViewPriceType, cardViewtBidingTimer, meraCardView;
                                    ...
                                    if (parentView.getId() == 2222)
                                        if (subcatDiloglistitem.isBidding() && !String.valueOf(subcatDiloglistitem.isBidding()).equals("")) {
                                            ...
                                            if (!String.valueOf(subcatDiloglistitem.isBidding()).equals("")) {
                                                if (subcatDiloglistitem.isBidding()) {
                                                    meraCardView.setVisibility(View.VISIBLE);
                                                } else {
