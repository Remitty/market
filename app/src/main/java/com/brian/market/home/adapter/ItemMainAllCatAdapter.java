...
public class ItemMainAllCatAdapter extends RecyclerView.Adapter<ItemMainAllCatAdapter.CustomViewHolder> {
    ...
    public ItemMainAllCatAdapter(Context context, ArrayList<homeCatListModel> feedItemList, int noOFCol, boolean show) {
        this.feedItemList = feedItemList;
        this.mContext = context;
        this.noOfCol = noOFCol;
        this.show_image = show;
    }
...
//        customViewHolder.imageView.setBackgroundColor(Color.parseColor(feedItem.getBGColor()));
