 ...
 */
public class FragmentTopLocations extends Fragment {
    ...
    static JSONArray top_location_list;
    public FragmentTopLocations() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_top_locations, container, false);
    }
    public static void setData(JSONArray jsonArray) {
        FragmentTopLocations.top_location_list=jsonArray;
    }
    @Override
...
//    }
    ...
    private void adforest_setAllLocationAds() {
...
//        locationAdscat.clear();
        for (int i = 0; i <top_location_list .length(); i++) {
            homeCatListModel item = new homeCatListModel();
            JSONObject jsonObject = null;
            try {
                jsonObject=top_location_list.getJSONObject(i);
                item.setId(jsonObject.getString("location_id"));
                item.setTitle(jsonObject.getString("location_name"));
                locationAdscat.add(item);
            } catch (JSONException e) {
                e.printStackTrace();
            }
