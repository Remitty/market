...
import com.brian.market.helper.ItemLanguageOnclicklinstener;
...
//        View view = null;
//        if(isMultiLine)
//            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_layout_multi,viewGroup,false);
//        else
//            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_layout,viewGroup,false);
//        view.getLayoutParams().width = (int) (getScreenWidth() / 3);
